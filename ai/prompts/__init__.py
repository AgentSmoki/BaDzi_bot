...
INSTRUCTION_PREFIX: Final = "\n".join(
    [
        ...
        "  «Натальные звёзды» как bullet-список. Это техническая",
        "  раскладка БД, не текст для клиента. Синтезируй 2-3 главных",
        "  фактора в нарратив, остальное используй для своего вывода.",
        "- Каждый китайский термин или иероглиф ОБЯЗАТЕЛЬНО даёшь с",
        "  inline-расшифровкой при первом упоминании: «「七杀」 (Семь",
        "  Убийств) — энергия давления, словно строгий начальник».",
        "  Голый иероглиф без расшифровки — критическая ошибка.",
