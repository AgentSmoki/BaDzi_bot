...
_CALENDAR_KEYWORDS: Final[tuple[str, ...]] = (
    ...
    "в какой день",
    "в какую дату",
    # Расширенный набор (после инцидента 2026-05-25 с @S_Kate2011 —
    # бот выдал прошедшие даты для чайных церемоний, потому что её
    # вопрос не матчил ни один keyword).
    "когда провести",
    "когда мне провести",
    "когда мне можно",
...
_EVENT_KEYWORDS: Final[dict[EventType, tuple[str, ...]]] = {
    ...
    "spiritual": (
        "медитац",
        "чайн",  # чайная церемония, чайный ритуал
        "ритуал",
        "духовн",
        "практик",  # духовная практика, телесная практика
        "церемони",
        "ретрит",
        "выезд",  # выезд на ретрит
        "интенсив",
    ),
}
