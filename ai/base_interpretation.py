...
follow-up вопрос в формате (используй HTML-теги <b> и <u> ровно так):

<b><u>Чтобы узнать больше, задайте вопрос по этой карте:</u></b> \
«<один конкретный вопрос, раскрывающий тему блока глубже>»

Пример строки для блока 4 (Идеальный партнёр):
<b><u>Чтобы узнать больше, задайте вопрос по этой карте:</u></b> \
«Какой типаж партнёра мне максимально подходит и где его искать?»
