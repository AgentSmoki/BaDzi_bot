...
Each block ends with a single ``**Дальше можно спросить:** «...»``
...
follow-up вопрос в формате:

**Дальше можно спросить:** «<один конкретный вопрос, который раскрывает тему блока глубже>»

Пример строки для блока 4 (Идеальный партнёр):
**Дальше можно спросить:** «Какой типаж партнёра мне максимально подходит и где его искать?»

Follow-up должен быть КОНКРЕТНЫМ (не «расскажи больше»), коротким (10-20 слов), \
и явно вытекать из содержания блока."""
