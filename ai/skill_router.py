...
1. ``select_skill(question, chart, history)`` — this module, fast LLM
   call (~1-2 s on Qwen3.6 max_tokens=2000; will be ~0.5 s when YC
   adds Qwen3-3B). Returns ``SkillSelection`` with skill name,
   clarifying questions, partner-chart hint, and concept hints for RAG.
