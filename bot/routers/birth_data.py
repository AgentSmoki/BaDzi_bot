...
SMART_EXTRACT_FAILED = "Не разобрал текст автоматически — давайте по шагам. Назовите дату рождения."
SMART_EXTRACT_PARTIAL = "Записал что смог. Уточните, пожалуйста, недостающее."
PARTNER_DATE_PROMPT = (
    "Чтобы сравнить вашу карту с картой партнёра, мне нужны его данные.\n\n" + DATE_PROMPT
)
PARTNER_SAVED_MSG = (
    "Карта партнёра сохранена. Я подключил её к вашему вопросу — сейчас отвечу с учётом обеих карт."
)
DATE_INVALID = (
    "Не разобрал «{text}». Можно цифрами (15.07.1990), словами (15 июля 1990), "
...
TIME_INVALID = (
    "Не разобрал «{text}». Можно так: 14:30, 14.30, 14,30, 14-30, 1430, или просто час: 14."
)
...
CITY_NOT_FOUND = (
    "Не нашёл «{query}». Похоже на опечатку — проверьте написание и попробуйте ещё раз. "
    "Можно с уточнением региона: «Тверь, Тверская область»."
)
CITY_CHOICES = "Нашёл несколько вариантов — выберите свой:"
