...
RESEARCH_TOOL_ENV = Path("~/Documents/Razarabotka/Dev_Architect/research_tool/.env")
OPENROUTER_API_KEY = ""
...
OUTPUT_PATH = Path(
    "~/Documents/Razarabotka/BaDzi_bot/doc/research/structures_v2_perplexity_deep.md"
)
